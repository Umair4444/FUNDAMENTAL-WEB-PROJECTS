// Input area
let hoursinput = document.getElementById("hours-counter");
let minutesinput = document.getElementById("minutes-counter");
let secondsinput = document.getElementById("seconds-counter");
// Buttons
...
// Display area
let hoursel = document.getElementsByClassName("hours");
...
let interval = null; // Adjusted for browser
let isPaused = false;
